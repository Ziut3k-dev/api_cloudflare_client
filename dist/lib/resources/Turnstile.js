...
class Turnstile extends Resource_1.default {
     ...
     */
    async browse(accountId, page = 1, per_page = 25) {
     ...
     * @returns {Promise<Object>}
     */
    async edit(accountId, sitekey, data) {
        return this.apiClient.request({
            method: 'PUT',
            uriPath: undefined,
            data,
     ...
     * @returns {Promise<Object>}
     */
    async rotateSecret(accountId, sitekey, data = {}) {
        return this.apiClient.request({
            method: 'POST',
