...
class EnterpriseZoneWorkersKV extends Resource_1.default {
     ...
     */
    async browse(accountId, namespaceId) {
     ...
     * @returns {Promise<Object>} The KV response object.
     */
    async add(accountId, namespaceId, id, value) {
        return this.apiClient.request({
            method: 'PUT',
            path: `values/${id}`,
            data: value,
     ...
     * @returns {Promise<Object>} The KV response object.
     */
    async read(accountId, namespaceId, id) {
        return this.apiClient.request({
            method: 'GET',
            path: `values/${id}`,
            json: false,
     ...
     * @returns {Promise<Object>} The KV response object.
     */
    async del(accountId, namespaceId, id) {
        return this.apiClient.request({
            method: 'DELETE',
            path: `values/${id}`,
            params: { accountId, namespaceId },
     ...
     * @returns {Promise<Object>} The KV response object.
     */
    async addMulti(accountId, namespaceId, data) {
        return this.apiClient.request({
            method: 'PUT',
            path: 'bulk',
            data,
     ...
     * @returns {Promise<Object>} The KV response object.
     */
    async delMulti(accountId, namespaceId, data) {
        return this.apiClient.request({
            method: 'DELETE',
            path: 'bulk',
            data,
...
exports.default = EnterpriseZoneWorkersKV;
