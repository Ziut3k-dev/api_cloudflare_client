...
class EnterpriseZoneWorkersKV extends Resource {
   ...
   * @returns {Promise<Object>} The KV response object
   */
  add(accountId: string, namespaceId: any, id: string, value: any) {
   ...
   * @returns {Promise<Object>} The KV response object
   */
  read(accountId: string, namespaceId: any, id: string) {
    return this.apiClient.request(
      {
        method: 'GET',
        path: `values/${id}`,
   ...
   * @returns {Promise<Object>} The KV response object
   */
  del(accountId: string, namespaceId: any, id: string) {
    return this.apiClient.request(
      {
        method: 'DELETE',
        path: `values/${id}`,
   ...
   * @returns {Promise<Object>} The KV response object
   */
  addMulti(accountId: string, namespaceId: any, data: any) {
    return this.apiClient.request(
      {
        method: 'PUT',
        path: 'bulk',
   ...
   * @returns {Promise<Object>} The KV response object
   */
  delMulti(accountId: string, namespaceId: any, data: any) {
    return this.apiClient.request(
      {
        method: 'DELETE',
        path: 'bulk',
