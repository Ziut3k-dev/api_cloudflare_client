...
class EnterpriseZoneWorkersKV extends Resource {
   ...
   */
  async browse(accountId: string, namespaceId: any) {
   ...
   * @returns {Promise<Object>} The KV response object.
   */
  async add(accountId: string, namespaceId: any, id: string, value: any) {
    return this.apiClient.request(
      {
        method: 'PUT',
        path: `values/${id}`,
   ...
   * @returns {Promise<Object>} The KV response object.
   */
  async read(accountId: string, namespaceId: any, id: string) {
    return this.apiClient.request(
      {
        method: 'GET',
        path: `values/${id}`,
   ...
   * @returns {Promise<Object>} The KV response object.
   */
  async del(accountId: string, namespaceId: any, id: string) {
    return this.apiClient.request(
      {
        method: 'DELETE',
        path: `values/${id}`,
   ...
   * @returns {Promise<Object>} The KV response object.
   */
  async addMulti(accountId: string, namespaceId: any, data: any) {
    return this.apiClient.request(
      {
        method: 'PUT',
        path: 'bulk',
   ...
   * @returns {Promise<Object>} The KV response object.
   */
  async delMulti(accountId: string, namespaceId: any, data: any) {
    return this.apiClient.request(
      {
        method: 'DELETE',
        path: 'bulk',
