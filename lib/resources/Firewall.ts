...
class Firewall extends Resource {
   ...
   */
  async read(zoneId: string, ruleId: string) {
    return this.apiClient.request(
      {
        method: 'GET',
   ...
   * @returns {Promise<Object>} The zone response object.
   */
  async edit(id: string, ruleId: string, rule: any) {
    return this.apiClient.request(
      {
        method: 'PUT',
   ...
   * @returns {Promise<Object>} The zone response object.
   */
  async add(zoneId: string, rules: any) {
    return this.apiClient.request(
      {
        method: 'POST',
        uriPath: 'zones/:zoneId/firewall/rules',
   ...
   * @returns {Promise<Object>} The zone response object.
   */
  async del(zoneId: string, ruleId: string) {
    return this.apiClient.request(
      {
        method: 'DELETE',
        uriPath: 'zones/:zoneId/firewall/rules/:ruleId',
